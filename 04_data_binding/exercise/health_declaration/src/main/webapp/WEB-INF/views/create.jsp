...
<div align="center">
    ...
    <h4>ĐÂY LÀ TÀI LIỆU QUAN TRỌNG, THÔNG TIN CỦA ANH/CHỊ SẼ GIÚP CƠ QUAN Y TẾ LIÊN LẠC KHI CẦN THIẾT ĐỂ PHÒNG CHÓNG DỊCH</h4>
...
<div class="container-fluid col-lg-12">
    <form:form modelAttribute="people" cssClass="row g-3" method="post" action="/create">
        <div class="col-12">
        ...
        <div class="col-md-4">
            <label for="input-commune" class="form-label">Quận huyện</label>
        ...
        <div class="col-md-12">
            <b>Trong vòng 14 ngày qua, Anh/Chị có đi đến tỉnh/thành phố nào?</b>
        </div>
        <div class="col-md-6">
            <table>
                <tr>
        ...
        <div class="col-md-6">
            <table>
                ...
                <tr>
                    <td>Nôn/buồn nôn</td>
                    <td><form:checkbox path="symptom" value="Nôn/buồn nôn"/></td>
                    <td><input class="form-check-input" type="checkbox" value=""></td>
                </tr>
                <tr>
                    <td>Tiêu chảy</td>
                    <td><form:checkbox path="symptom" value="Tiêu chảy"/></td>
                    <td><input class="form-check-input" type="checkbox" value=""></td>
                </tr>
                <tr>
                    <td>Xuất huyến ngoài da</td>
                    <td><form:checkbox path="symptom" value="Xuất huyến ngoài da"/></td>
                    <td><input class="form-check-input" type="checkbox" value=""></td>
                </tr>
                <tr>
                    <td>Nổi ban</td>
                    <td><form:checkbox path="symptom" value="Nổi ban"/></td>
                    <td><input class="form-check-input" type="checkbox" value=""></td>
                </tr>
            </table>
        </div>
        <div class="col-12">
            <b>Lịch sữ phơi nhiễm: Trong vòng 14 ngày qua, Anh/Chị có</b>
        </div>
        <div class="col-12">
            <table>
                <tr>
                ...
                <tr>
                    <td>Đến trang trại chăn nuôi/chợ buôn bán động vật sống/cơ sở giết mổ động vật/tiếp xúc đông vật
                    </td>
                    <td><form:checkbox path="exposureHistory" value="Đến chỗ cơ sở chăn nuôi/giết mổ động vật"/></td>
                    <td><input class="form-check-input" type="checkbox" value=""></td>
                </tr>
                <tr>
                    <td>Tiếp xúc gần(<2m) với người mắc bệnh viêm đường hô hấp do Covid</td>
                    <td><form:checkbox path="exposureHistory" value="Tiếp xúc người bệnh"/></td>
                    <td><input class="form-check-input" type="checkbox" value=""></td>
                </tr>
            </table>
        </div>
        ...
        <div class="col-12">
            <input style="background-color: palegreen" align="center" type="submit" value="Gửi tờ khai">
        </div>
    </form:form>
</div>
</body>
