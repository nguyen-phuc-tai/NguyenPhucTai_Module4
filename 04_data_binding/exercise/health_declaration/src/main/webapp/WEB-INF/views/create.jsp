...
<div class="container-fluid col-lg-12">
    <form:form modelAttribute="people" cssClass="row g-3" method="post" action="/peoples/create">
        <div class="col-12">
        ...
        <div class="col-12">
            <div align="center">
                <input style="background-color: palegreen"  type="submit" value="Gửi tờ khai">
            </div>
